...
namespace Com\Jardineria\Traits;
...
trait BaseRestController
{
    ...
    /**
     * En peticiones con Body (PUT, PATCH), devuelve el array con los parámetros que se han pasado en la petición (request)
     * @return array con los parámetros enviados en la petición
     */
